...
completed = [
  '01001', '01019', '01033', '01045', '01049', '01057', '01059',
  ...
  '05069', '06087', '06087', '08005', '08014', '08039', '08119',
  '12001', '13113', '13135', '13097', '13115', '13187', '17203',
  '18063', '18149', '19013', '19033', '19045', '19079', '19021',
  '19141', '19119', '19167', '19193', '19059', '20013', '20017',
  '20021', '20031', '20055', '20085', '20151', '20155', '20163',
  '20169', '20181', '20191', '20193', '20195', '20207', '20209',
  '20087', '20147', '21001', '21003', '21007', '21013', '21115',
  '21015', '21027', '21029', '21041', '21051', '21085', '21093',
  '21111', '21151', '21173', '21195', '21207', '21235', '21239',
  '21031', '21047', '21133', '21219', '21009', '21019', '21021',
  '21035', '21043', '21045', '21055', '21059', '21073', '21075',
  '21081', '21089', '21095', '21101', '21107', '21109', '21121',
  '21123', '21125', '21131', '21135', '21137', '21155', '21161',
  '21145', '21179', '21183', '21199', '21203', '21205', '21209',
  '21211', '21217', '21225', '21233', '22061', '22001', '22003',
  ...
  '22007', '22093', '22057', '22089', '27005', '27007', '27013',
  '27023', '27015', '27017', '27055', '27067', '27079', '27131',
  '27169', '27171', '27173', '28081', '28025', '28067', '28069',
  '28133', '28143', '29009', '29031', '29101', '29109', '29141',
  '29209', '30031', '34011', '37023', '38105', '38101', '39005',
  '39025', '39041', '39043', '39063', '39099', '39129', '39027',
  '39053', '39013', '39049', '39049', '39059', '39061', '39061',
  '39061', '39077', '39083', '39107', '39123', '39143', '40031',
  '40125', '40023', '40037', '40097', '40087', '40111', '40117',
  '40131', '40145', '48331', '48395', '48445', '48451', '55033']
...
d3.json("https://unpkg.com/us-atlas@1/us/10m.json").then(function(us) {
  ...
  d3.csv('BJS_capacity.csv').then(function(data) {
    data.forEach(d => d.CAPACITY = +d.CAPACITY);
    let counties = topojson.feature(us, us.objects.counties).features;
    counties
      .forEach(function(d) {
        let jail = data.filter(c => c.CNTYCODE == d.id);
        d.population = jail.length > 0 ? jail[0].CAPACITY : 0;
    });
    ...
    map.append("g")
      ...
      .join("circle")
        ...
        .attr("stroke", d => five_largest.includes(d.id) ? "#000" : "#fff")
