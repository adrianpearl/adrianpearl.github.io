d3.csv("mpi_region_contributions.csv").then(function(regions) {
  d3.csv("mpi_country_contributions.csv").then(function(countries) {
    d3.csv("mpi_subnational_contributions.csv").then(function(subnational) {
      ...
      // BACKGROUND
      svg.append("rect").attr("width", width).attr("height", height).attr("fill", "#f4f4f4");
